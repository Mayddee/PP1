...
#Fonts
font = pygame.font.SysFont(r"Verdana", 60)
font_small = pygame.font.SysFont(r"Verdana", 20)
game_over = font.render(r"Game Over", True, BLACK)

background = pygame.image.load(r"Week12/lab09/Racer/AnimatedStreet.png")

#Creates a white screen 
DISPLAYSURF = pygame.display.set_mode((400,600))
DISPLAYSURF.fill(WHITE)
pygame.display.set_caption(r"Game")


class Enemy(pygame.sprite.Sprite):
      def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"Week12/lab09/Racer/Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r"Week12/lab09/Racer/Player.png")
        self.rect = self.image.get_rect()
...
class Coin(pygame.sprite.Sprite):
    #Генерация монеток
    def __init__(self, image, a, b, weight):
        super().__init__()
...
#Numbers coins
for i in range(2):
    c1 = Coin(r'Week12/lab09/Racer/coin.png', 40, 40, 1)
    coins_group.add(c1)
    all_sprites.add(c1)
for i in range(1):
    c2 = Coin(r'Week12/lab09/Racer/coin.png', 20, 20, 2)
    coins_group.add(c2)
    all_sprites.add(c2)
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound(r'Week12/lab09/Racer/crash.wav').play()
          time.sleep(1)
